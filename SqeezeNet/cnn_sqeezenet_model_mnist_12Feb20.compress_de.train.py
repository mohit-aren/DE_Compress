...
for withtrain in range(0,5):
    ...
    olayer1_filters = layer1_filters
    olayer2_filters = layer2_filters
    olayer3_filters = layer3_filters
    olayer4_filters = layer4_filters
    
    model_final=SqueezeNet_compress(layer1_filters,layer2_filters,layer3_filters,layer4_filters, (48,48,3), 10)
    ...
    wt = 'sqeezenet_100epoch_'+ str(withtrain) + '.h5'
    ...
    ####################### 1st convolution layer with 256 filters
    print('1st convolution layer with olayer3_filters filters')
    A = []
    Acc = []
    ...
    ####################### 2nd convolution layer with 256 filters
    print('2nd convolution layer with olayer4_filters filters')
    A = []
    Acc = []
    ...
    for k in range(23,25):
        ...
        # normalize filter values to 0-1 so we can visualize them
        # plot first few filters
        n_filters, ix = olayer1_filters, 1
        ...
        index1 = 0
        # plot each channel separately
        for j in range(olayer1_filters):
            if(A1[j] == 1) :
                """
                for i1 in range (0,3):
                    for j1 in range(0,3):
    ...
    for k in range(25,26):
        ...
        for j in range(48):
            if(1 == 1) :
                index2  = 0
                for l in range(olayer1_filters):
                    if(A1[l] == 1):
                        filters1[:, :, index2*2, index1] = filters[:, :, l*2, j]
                        filters1[:, :, index2*2+1, index1] = filters[:, :, l*2+1, j]
                        index2 += 1
    ...
    for k in range(27,29):
        ...
        # normalize filter values to 0-1 so we can visualize them
        # plot first few filters
        n_filters, ix = olayer2_filters, 1
        ...
        index1 = 0
        # plot each channel separately
        for j in range(olayer2_filters):
            if(A2[j] == 1) :
                """
                for i1 in range (0,3):
                    for j1 in range(0,3):
    ...
    for k in range(29,30):
        ...
        for j in range(64):
            if(1 == 1) :
                index2  = 0
                for l in range(olayer2_filters):
                    if(A2[l] == 1):
                        filters1[:, :, index2*2, index1] = filters[:, :, l*2, j]
                        filters1[:, :, index2*2+1, index1] = filters[:, :, l*2+1, j]
                        index2 += 1
    ...
    for k in range(30,32):
        ...
        # normalize filter values to 0-1 so we can visualize them
        # plot first few filters
        n_filters, ix = olayer3_filters, 1
        ...
        index1 = 0
        # plot each channel separately
        for j in range(olayer3_filters):
            if(A3[j] == 1) :
                """
                for i1 in range (0,3):
                    for j1 in range(0,3):
    ...
    for k in range(32,35):
        ...
        for j in range(64):
            if(1 == 1) :
                index2  = 0
                for l in range(olayer3_filters):
                    if(A3[l] == 1):
                        filters1[:, :, index2*2, index1] = filters[:, :, l*2, j]
                        filters1[:, :, index2*2+1, index1] = filters[:, :, l*2+1, j]
                        index2 += 1
    ...
    for k in range(35,37):
        ...
        # normalize filter values to 0-1 so we can visualize them
        # plot first few filters
        n_filters, ix = olayer4_filters, 1
        ...
        index1 = 0
        # plot each channel separately
        for j in range(olayer4_filters):
            if(A4[j] == 1) :
                """
                for i1 in range (0,3):
                    for j1 in range(0,3):
    ...
    wt1 = 'sqeezenet_100epoch_'+ str(withtrain+1) + '.h5'
